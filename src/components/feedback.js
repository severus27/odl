  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      {feedbackSent ? (
        ...
        <>
          <h4>Help us out by providing feedback on this page:</h4>
          <div style={{ display: "flex", gap: "5px" }}>
            ...
            >
              <FiThumbsUp  style={{ width: "20px", height: "20px", color: "#0ba37f" }}/>
            </div>
            <div
              {...defaultFields}
              role="button" // Make it recognized as an interactive element
            ...
            >
              <FiThumbsDown style={{ width: "20px", height: "20px", color: "#981B1B" }}/>
            </div>
          </div>
        </>
      )}
